...
from sort_of_clevr_and_babi.baselines.sam.qamodel import InputModule
...
if __name__ == "__main__":
    ...
    parser.add_argument("--serialization-path", type=str, metavar='PATH', default="./Params_88_10_7_9_0.0002_topk5_SDMTR/",
