...
python sort_main.py --model Transformer --epochs 200 --embed_dim $embed_dim --num_layers $num_layers --functional $set_transformer --share_vanilla_parameters $share_vanilla_parameters \
