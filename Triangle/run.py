...
log_dir = './logs_triangle_SDMTR_128_256_4N_'
...
parser.add_argument('--patch_size', default=32, type=int, help='patch_size for transformer')  # default=4
...
parser.add_argument('--use_long_men', type=str2bool, default=False,
